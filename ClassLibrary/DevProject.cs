...
namespace ClassLibrary
{
    ...
    class DevProject : BaseEntity
    {
        ...
        public DevProject(string projectname, DateTime startdate, DateTime finishdate, Performer projectleader, Company projectcustomer,
